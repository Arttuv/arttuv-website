...
As you can see, there is only three action related sections here and the model was called seven stages of action. Execution and evaluation can both be divided to three subtasks.
